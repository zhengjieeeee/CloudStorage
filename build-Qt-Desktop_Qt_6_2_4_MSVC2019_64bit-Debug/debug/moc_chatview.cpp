...
#include <memory>
#include "../../Client/Qt/Qt/chatview.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_chatView_t, stringdata0) + ofs), len 
...
const QMetaObject chatView::staticMetaObject = { {
    ...
    qt_meta_stringdata_chatView.offsetsAndSize,
    qt_meta_data_chatView,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_chatView_t
